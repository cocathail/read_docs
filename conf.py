# -*- coding: utf-8 -*-
#
# training_modules documentation build configuration file, created by
# sphinx-quickstart on Fri Jan 27 16:40:00 2017.
#
...
copyright = u'2017-2024, European Nucleotide Archive (ENA). Licensed under the Apache License 2.0.'
...
htmlhelp_basename = 'training_modulesdoc'
...
latex_documents = [
    (master_doc, 'training_modules.tex', u'training\\_modules Documentation',
     u'Marc B Rossello', 'manual'),
]
...
man_pages = [
    (master_doc, 'training_modules', u'training_modules Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'training_modules', u'training_modules Documentation',
     author, 'training_modules', 'One line description of project.',
     'Miscellaneous'),
]
