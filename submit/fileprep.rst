...
In the case of any data submitted :doc:`Interactively </submit/general-guide/interactive>` or 
:doc:`Programmatically </submit/general-guide/programmatic>` you will also need to register the 
md5 checksum of your files and upload these to your Webin Upload Area prior to submission. 

If data is submitted using :doc:`Webin-CLI </submit/general-guide/webin-cli>` there is no need 
